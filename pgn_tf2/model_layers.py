...
from utils.config import save_wv_model_path, save_vocab_path
...
class BahdanauAttention(tf.keras.layers.Layer):
    ...
    def __call__(self, dec_hidden, enc_output, enc_pad_mask, use_coverage=False, prev_coverage=None):
        ...
        if use_coverage and prev_coverage is not None:
            ...
            # print("enc_output.shape: %s, hidden_with_time_axis.shape: %s, prev_coverage.shape: %s\n" % (enc_output.shape, hidden_with_time_axis.shape, prev_coverage.shape))
