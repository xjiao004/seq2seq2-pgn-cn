...
import sys
sys.path.append("/home/supernode/Documents/Workspace/AIExercise/NLP/Project01/07Week/exercise/encoder-decoder-attention")
import re
import jieba
import pandas as pd
...
from utils.config import train_seg_path, test_seg_path, merger_seg_path, user_dict, train_x_seg_path, test_x_seg_path, \
    ...
    save_vocab_path, reverse_vocab_path, train_x_path, train_y_path, test_x_path, embedding_dim, train_y_seg_path, \
